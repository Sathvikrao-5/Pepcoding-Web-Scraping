...
url = "https://collegedunia.com/thrissur-colleges"
...
workbook = xlsxwriter.Workbook("result_sheet.xlsx")
for college,table_data,clg_sum in zip(clg_names,td_data,clg_summaries):
    worksheet = workbook.add_worksheet(college[:29]+str(random.choice([1,2,3,4,5,6,7,8,9,0,10,20,30,4])))
